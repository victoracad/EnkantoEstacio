<?php 
    $sql = "SELECT * FROM comandas ORDER BY CASE WHEN status = 'ABERTA' THEN 0 ELSE 1 END, id DESC";
        ...
        while($user_data7 = mysqli_fetch_assoc($result7)){
            $nameClientDb = $user_data7['nome'];
                ...
                <div class=\"btn_actions\">
                    <a href=\"./methods/close_comanda.php?id=$user_data4[id]\"><button class=\"btn_fechar\">Fechar Conta</button></a>
                </div>
            </div>";
    }
